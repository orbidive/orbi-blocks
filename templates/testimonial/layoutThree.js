...
export default function layoutthree(props) {
    const { attributes, className, setAttributes } = props;
        ...
        return(
            <Fragment >
                <div className={`orbi-testimonial-wrapper-${attributes.yourId} orbi-testimonial-card testimonial_three`} onClick={OpenSidebar}>
                    <div class="sub-qute">
                        {attributes.showImage &&
                            <div class="testi-img orbi-testimonial-card-image">
                            <img src={ attributes.image } class="clg" alt="client"/>
                                {attributes.showIcon &&
                                    <div className='orbi-testimonial-card-icon'>
